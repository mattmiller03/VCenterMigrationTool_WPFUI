...
try {
    ...
    $migrationStats.SourcePermissionsFound = $sourcePermissions.Count
    Write-LogInfo "Found $($sourcePermissions.Count) permissions in source vCenter" -Category "Discovery"
    ...
    if ($sourcePermissions.Count -eq 0) {
